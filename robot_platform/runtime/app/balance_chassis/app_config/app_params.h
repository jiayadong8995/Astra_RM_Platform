...
#define APP_DETECT_TASK_STACK_BYTES     512U
...
#define APP_DETECT_TASK_PRIORITY         osPriorityNormal

#define APP_CHASSIS_STARTUP_DELAY_MS     6U

/* Backward-compatible aliases used by control layer code. */
#define CONTROL_INS_TASK_PERIOD_MS          INS_TASK_PERIOD_MS
#define CONTROL_CHASSIS_TASK_PERIOD_MS      CHASSIS_TASK_PERIOD_MS
#define CONTROL_MOTOR_CONTROL_TASK_PERIOD_MS MOTOR_CONTROL_TASK_PERIOD_MS
#define CONTROL_OBSERVE_TASK_PERIOD_MS      OBSERVE_TASK_PERIOD_MS
#define CONTROL_CHASSIS_STARTUP_DELAY_MS    APP_CHASSIS_STARTUP_DELAY_MS
